...
\def\entity[#1,#2]#3;{
  \node[draw,drop shadow={opacity=.4,shadow xshift=0.04, shadow
    yshift=-0.04},color=black,fill=white,rounded corners=3] (#1) at #2 {#3};
}
...
\begin{center}
  \begin{tikzpicture} [scale=1.2, transform shape]
    \small
    \kbbox[144,150,south,Peer1,(0,1.25)] {Peer};
    \tboxl[40,100,north,t1,(-0.5,2.7)] {$Egal Car$};
    \entity[Module,(-0.8,2.4)] {$Network Module$};
    \tboxl[12,40,north,t1,(1.3,2.4)] {$Egal$};
    \aboxr[20,50,1.4,Repo,(-1,1.2)] {$Repository$};
    \entity[Sync,(-1,0.4)] {$CCNx Sync$};
    \entity[Daemon,(-0.8,-0.5)] {$CCNx Daemon$};
    \isaedge[Module,Repo,,];
    \isaedge[Repo,Sync,,];
    \isaedge[Sync,Daemon,,];
    \draw[->,color=black!20!black,,,] plot [smooth,tension=1.5] coordinates{(-0.8,2.17) (0.4,0.85) (-0.8,-0.27)};

    \kbbox[30,60,south,Peer2,(4,0.5)] {Peer};
    \kbbox[30,60,south,Peer3,(4,-1)] {Peer};
     \draw[<->,color=black!20!black,,,] (0.4,-0.5) -- (3,0);
     \draw[<->,color=black!20!black,,,] (0.4,-0.5) -- (3,-1);
  \end{tikzpicture}
\caption{default}
\label{default}
\end{center}
