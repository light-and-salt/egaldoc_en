...
\label{sec:cm}
% virtual world is shared, so replications exist, so you need consistency, so you need synchronization
...
% this sync problem is not the same as the file sync problem
